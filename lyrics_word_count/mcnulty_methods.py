...
def get_formatted_feature_df(conn):
    import pandas as pd
    ...
    where_clause = '''ta.track_id = tm.target_id AND (m_term.term = 'hip hop' OR m_term.term = 'pop')'''

    query = '''SELECT {} FROM artist_main_term m_term
    ...
    #INNER JOIN stopless_lyrics l ON tm.track_id = l.track_id
